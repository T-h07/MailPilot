...
$onboardingApply = Invoke-ApiCheck -Area "onboarding" -Method "POST" -Path "/api/onboarding/view-proposals/apply" -Body @{ create = @() }
Add-Result -Results $results -Result $onboardingApply
