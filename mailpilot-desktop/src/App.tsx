...
function AppShell() {
  ...
  const pageTitle = useMemo(
    () => resolveHeaderTitle(location.pathname),
    [location.pathname],
  );
  ...
  return (
    <div className="flex h-screen bg-background text-foreground">
      <aside className="hidden w-[260px] shrink-0 border-r bg-card/60 md:block">
        <Sidebar />
      </aside>
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/85 md:px-6">
          ...
          <div className="flex items-center gap-2">
            <Input
              className="hidden w-64 bg-card lg:flex"
...
function ComposeDialog() {
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Compose placeholder</DialogTitle>
          <DialogDescription>
            Message composer will be implemented in a later milestone.
          </DialogDescription>
        </DialogHeader>
        <Input disabled placeholder="Recipient (coming soon)" />
        <DialogFooter>
